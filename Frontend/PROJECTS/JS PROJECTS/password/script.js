...
function calcStrength(){
    ...
    {
        // setIndicator("#ccc");  initilize at starting
        setIndicator("#0f0");
    }
...
//is is promise means it either resolve or reject so we have to make async function
...
//funciton if any error occur
catch(e){
    copyMsg.innerText="failed";
}

//to make copy span visible/ copid msg visible 
...
function handleCheckBoxChange(){
    //this function help to decide the color of strength because color depends on no. of box checked  
    // let checkCount=0; initilize in starting 
    checkCount=0;
...
if(passwordLength < checkCount){ //let passwordLength=10; checkcount=0 initilize in starting
